...
CheckoutPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/checkout/checkout.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Checkout</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding class="checkout" style="background-color: #f4f4f4;">\n	<ion-card>\n		<ion-card-content>\n			<ion-item>\n				Credit / Debit / ATM Card\n				<ion-icon name="arrow-forward" item-right></ion-icon>\n			</ion-item>\n\n			<ion-item>\n				Net Banking\n				<ion-icon name="arrow-forward" item-right></ion-icon>\n			</ion-item>\n\n			<ion-item>\n				Cash on Delivery\n				<ion-icon name="arrow-forward" item-right></ion-icon>\n			</ion-item>\n\n			<ion-item>\n				EMI (Easy Installments)\n				<ion-icon name="arrow-forward" item-right></ion-icon>\n			</ion-item>\n		</ion-card-content>\n	</ion-card>\n\n	<ion-card>\n		<ion-card-content>\n		  <ion-item>\n				<p>PRICE DETAILS</p>\n		  </ion-item>\n			<!-- <ion-row class="detail-row">\n				<p>PRICE DETAILS</p>\n			</ion-row>\n			<ion-row>\n				<ion-col width-70>\n				  <p>Price(1 item)</p>\n				  <p>Delievery</p>\n				</ion-col>\n				<ion-col width-30>\n				    <p style="text-align: right;">{{ 499 | currency:\'INR\'}}</p>\n				    <p style="text-align: right;color: #388e3c;">Free</p>\n				</ion-col>\n			</ion-row> -->\n			\n		</ion-card-content>\n	</ion-card>\n\n</ion-content>\n'/*ion-inline-end:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/checkout/checkout.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */]])
], CheckoutPage);
...
SettingsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-settings',template:/*ion-inline-start:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/settings/settings.html"*/'<!--\n  Generated template for the Settings page.\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n<ion-header>\n\n	<ion-navbar>\n		<button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n		<ion-title>Settings</ion-title>\n		<ion-buttons end>\n      <button ion-button icon-only (click)="presentPopover($event)">\n        <ion-icon name="more"></ion-icon>\n      </button>\n    </ion-buttons>\n	</ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n	<ion-list no-lines>\n    <ion-item>\n      <ion-label>Language</ion-label>\n      <ion-select [(ngModel)]="language" (ionChange)="setLanguage(language)">\n        <ion-option value="en" selected> English</ion-option>\n        <ion-option value="es">Spanish </ion-option>\n      </ion-select>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/settings/settings.html"*/
    }),
...
WishlistPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/wishlist/wishlist.html"*/'<ion-header>\n  <ion-navbar no-border-bottom>\n  	<ion-title>Wishlist</ion-title>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-buttons end>\n      <button ion-button (click)="goToCart()">\n        <ion-icon ios="ios-cart" md="md-cart"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-buttons end>\n      <button ion-button (click)="presentPopover($event)">\n          <ion-icon ios="ios-more" md="md-more"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n	<ion-list>\n    <ion-list-header>\n      4 Items in your Wishlist (Swipe for options).\n    </ion-list-header>\n\n    <ion-item-sliding *ngFor="let product of products">\n      <ion-item>\n        <ion-avatar item-left>\n		      <img [src]="product.image">\n		    </ion-avatar>\n		    <h2>{{product.name}}</h2>\n		    <h3>{{product.price | currency}}</h3>\n		    <p>{{product.rating}} stars and 420 reviews</p>\n      </ion-item>\n      <ion-item-options side="right">\n	      <button ion-button color="danger">\n	        <ion-icon name="trash"></ion-icon>\n	        Remove\n	      </button>\n	      <button ion-button color="secondary">\n	        <ion-icon name="cart"></ion-icon>\n	        Add Cart\n	      </button>\n	    </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n	\n	<!-- <ion-list>\n		<ion-item-sliding>\n		  <ion-item *ngFor="let product of products">\n		    <ion-avatar item-left>\n		      <img [src]="product.image">\n		    </ion-avatar>\n		    <h2>{{product.name}}</h2>\n		    <h3>{{product.price | currency}}</h3>\n		    <p>{{product.rating}} stars and 420 reviews</p>\n		  </ion-item>\n		  <ion-item-options side="left">\n	      <button primary>\n	        <ion-icon name="trash"></ion-icon>\n	        Remove\n	      </button>\n	      <button secondary>\n	        <ion-icon name="cart"></ion-icon>\n	        Add\n	      </button>\n	    </ion-item-options>\n		</ion-item-sliding>\n	</ion-list> -->\n\n</ion-content>\n'/*ion-inline-end:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/wishlist/wishlist.html"*/,
    }),
...
SearchPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/search/search.html"*/'<ion-header>\n	<ion-navbar color="light">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-searchbar color="primary"\n                   [(ngModel)]="queryText"\n                   (ionInput)="updateSchedule()"\n                   placeholder="Search">\n    </ion-searchbar>\n<!--     <ion-searchbar (input)="getItems($event)"></ion-searchbar>\n -->  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n  <ion-list>\n    <ion-item>\n    	Hello\n    </ion-item>\n    <ion-item>\n    	test\n    </ion-item>\n    <ion-item>\n    	test\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/pages/search/search.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */]])
], SearchPage);
...
vPlanetApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/app/app.template.html"*/'<ion-split-pane>\n\n  <!-- logged out menu -->\n  <ion-menu id="loggedOutMenu" [content]="content">\n\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>{{\'menu\' | translate}}</ion-title>\n      </ion-toolbar>\n    </ion-header>\n\n    <ion-content class="outer-content">\n\n      <ion-list>\n        <ion-list-header>\n          {{\'navigate\' | translate}}\n        </ion-list-header>\n        <button ion-item menuClose *ngFor="let p of appPages" (click)="openPage(p)">\n          <ion-icon item-left [name]="p.icon" [color]="isActive(p)"></ion-icon>\n          {{ p.title | translate }}\n        </button>\n      </ion-list>\n\n      <ion-list>\n        <ion-list-header>\n          {{\'account\' | translate}}\n        </ion-list-header>\n        <button ion-item menuClose *ngFor="let p of loggedOutPages" (click)="openPage(p)">\n          <ion-icon item-left [name]="p.icon" [color]="isActive(p)"></ion-icon>\n          {{ p.title | translate }}\n        </button>\n        <button ion-item menuClose *ngFor="let p of otherPages" (click)="openPage(p)">\n          <ion-icon item-left [name]="p.icon" [color]="isActive(p)"></ion-icon>\n          {{ p.title | translate }}\n        </button>\n      </ion-list>\n    </ion-content>\n\n  </ion-menu>\n\n  <!-- logged in menu -->\n  <ion-menu id="loggedInMenu" [content]="content">\n\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Menu</ion-title>\n      </ion-toolbar>\n    </ion-header>\n\n    <ion-content class="outer-content">\n\n      <ion-list>\n        <ion-list-header>\n          {{\'navigate\' | translate}}\n        </ion-list-header>\n        <button ion-item menuClose *ngFor="let p of appPages" (click)="openPage(p)">\n          <ion-icon item-left [name]="p.icon" [color]="isActive(p)"></ion-icon>\n          {{ p.title | translate }}\n        </button>\n      </ion-list>\n\n      <ion-list>\n        <ion-list-header>\n          {{\'account\' | translate}}\n        </ion-list-header>\n        <button ion-item menuClose *ngFor="let p of loggedInPages" (click)="openPage(p)">\n          <ion-icon item-left [name]="p.icon" [color]="isActive(p)"></ion-icon>\n          {{ p.title | translate }}\n        </button>\n        <button ion-item menuClose *ngFor="let p of otherPages" (click)="openPage(p)">\n          <ion-icon item-left [name]="p.icon" [color]="isActive(p)"></ion-icon>\n          {{ p.title | translate }}\n        </button>\n      </ion-list>\n\n    </ion-content>\n\n  </ion-menu>\n\n\n  <!-- main navigation -->\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false" main></ion-nav>\n</ion-split-pane>\n'/*ion-inline-end:"/home/ajay/Desktop/sih/ionic3-ecommerce-app-master/src/app/app.template.html"*/,
